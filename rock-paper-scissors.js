...
function guess(youChoose) {
    ...
    if (compNumber >= 0 && compNumber <= 1/3) {
        computer = 'rock';
        compElement = '<i class="fa-solid fa-hand-fist" style="color: #ffffff;transform: scale(1.6);margin-left: 10px;"></i>';
    } else if (compNumber >= 1/3 && compNumber <= 2/3) {
        computer = 'paper';
        compElement = '<i class="fa-solid fa-hand" style="color: #ffffff;transform: scale(1.6);margin-left: 10px;"></i>';
    } else if (compNumber >= 2/3 && compNumber < 1) {
        computer = 'scissors';
        compElement = '<i class="fa-solid fa-hand-scissors" style="color: #ffffff;transform: scale(1.6);margin-left: 10px;"></i>';
    }

    if (computer === youChoose) {
        msg = 'Tie';
    } else if ((computer === 'rock' && youChoose === 'paper') || (computer === 'paper' && youChoose === 'scissors') ||(computer === 'scissors' && youChoose === 'rock')) {
        msg = 'You win';
    } else {
        msg = 'You lose';
    }
    ...
    if(youChoose === 'rock'){
        playerElement = '<i class="fa-solid fa-hand-fist" style="color: #ffffff;transform: scale(1.6);margin: 10px;"></i>';
    } else if(youChoose === 'paper'){
        playerElement = '<i class="fa-solid fa-hand" style="color: #ffffff;transform: scale(1.6);margin: 10px;"></i>';
    }  else if(youChoose === 'scissors'){
        playerElement = '<i class="fa-solid fa-hand-scissors" style="color: #ffffff;transform: scale(1.6);margin: 10px;"></i>';
    }
...
document.querySelector('.scissors-button').removeEventListener('click', () => {
    guess('scissors');
});
});
function autoplay() {
...
function areYouSure() {
    document.querySelector('.js-reset').
        innerHTML = '<p class = "areYouSure">Are you sure you want to reset the score?</p><button class="yesReset">Yes</button><button class="reset noReset">No</button>';
